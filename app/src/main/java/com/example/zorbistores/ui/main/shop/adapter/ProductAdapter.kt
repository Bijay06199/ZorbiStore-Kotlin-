package com.example.zorbistores.ui.main.shop.adapter
...
class ProductAdapter (val context:Context,private val listener:OnItemClickListener,var itemList:ArrayList<NewProductResponseItem>):RecyclerView.Adapter<ProductAdapter.ViewHolder>() {
