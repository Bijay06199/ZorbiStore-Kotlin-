package com.example.zorbistores.ui.main.home.onSale.adapter
...
class OnInnerSaleAdapter(private val context: Context, private val listener:OnItemClickListener, var cartItems:List<NewProductResponseItem>): RecyclerView.Adapter<OnInnerSaleAdapter.ViewHolder>(){
