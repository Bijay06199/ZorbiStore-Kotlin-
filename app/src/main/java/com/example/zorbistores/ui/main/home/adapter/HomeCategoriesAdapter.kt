...
class HomeCategoriesAdapter(private val context: Context,private val listener:OnItemClickListener, var itemList:ArrayList<CategoriesResponse>): RecyclerView.Adapter<HomeCategoriesAdapter.FeaturedViewHolder>(){
