...
class LatestProductAdapter (var context:Context,private val listener:OnItemClickListener, var cartItems: List<NewProductResponseItem>):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (!name.equals("Banner Test", ignoreCase = true) && !name.equals(
            ...
            var salePrice=cartItems[position].salePrice
            var regularPrice=cartItems[position].regularPrice
